...
# Набор состояний для того, чтобы запрашивать информацию и ждать ответа
...
# Функционал кнопки "Курс валют"
@dp.message(F.text == "Курс валют")
async def exchange_rates(message: Message):
    url = f"https://v6.exchangerate-api.com/v6/{RATES_API}/latest/USD"
    try:
...
# Функционал кнопки "Советы по экономии"
...
# Функционал кнопки "Личные финансы"
